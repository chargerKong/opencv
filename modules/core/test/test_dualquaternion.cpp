...
TEST_F(DualQuatTest, interpolation) {
    ...
    Mat gdqb(1, 2, CV_64FC(7));
    gdqb.at<Vec<double, 7>>(0, 0) = Vec<double, 7>{1,2,3,4,5,6,7};
    gdqb.at<Vec<double, 7>>(0, 1) = Vec<double, 7>{1,2,3,4,5,6,7};
    EXPECT_ANY_THROW(DualQuatd::gdqblend(gdqb, Vec2d{0.5, 0.5}));
